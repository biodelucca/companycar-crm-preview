...
export function SidePanel({ oportunidade, cliente, responsavel, usuarios = [], etapas, etapaAtual, motivosPerda = [], origens = [], timelineEventos, onFechar, onMoverEtapa, onReabrir, onTransferir, onChecklistMarcado, onAssociarVeiculoEstoque, onEditarDados, onExcluir, onSalvarProximaAcao, onConcluirProximaAcao, }) {
