// Única porta de entrada para o backend (Google Apps Script).
// Nenhum componente deve importar isto diretamente — sempre passar por um
// service de entidade (ex: services/oportunidades.ts), que expõe funções
// tipadas de domínio em vez de detalhes de transporte.
//
// URL do Web App do Apps Script. Definida via variável de ambiente do Vite
// (.env, não versionado) para poder trocar entre deploy de teste e produção
// sem alterar código.
